 ...
 */
public class TigerRpcServerEncoder extends MessageToByteEncoder<TigerRpcResponse> {

    @Override
    protected void encode(ChannelHandlerContext channelHandlerContext, TigerRpcResponse msg, ByteBuf byteBuf) {
